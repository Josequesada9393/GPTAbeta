...
export const AIPromptTextWithErros = `You will be provided with a text delimited by triple quotes. 
...
export const AIPromptListOfErrors = `You will be provided with a text delimited by triple quotes.
It will contain a text in English that may or may not have spelling, grammar, or vocabulary mistakes. 
