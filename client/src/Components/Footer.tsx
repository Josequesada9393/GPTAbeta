...
function Footer() {
  return (
    <footer className="text-gray-600 relative body-font  inline-block mt-auto ">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <div className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          <a className="flex title-font font-medium items-center text-black mb-4 md:mb-0" href='home'>
           <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-10 h-10 text-black p-1 bg-[#cc2936] rounded-full" viewBox="0 -2 13 19">
              <GiRainbowStar />
            </svg>
