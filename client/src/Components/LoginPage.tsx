...
<div className=''>
   <section className="text-gray-600 body-font">
      ...
      <div className="flex flex-wrap w-full">
        <div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
          <div className="flex relative pb-12">
           ...
           transition={{ duration: 1 }} className="flex-grow pl-4">
    ...
    initial={{ opacity: 0, scale: 0.5 }}
    animate={{ opacity: 1, scale: 1 }}
    transition={{ duration: 1.6 }} className="flex-grow pl-4">
    ...
    initial={{ opacity: 0, scale: 0.5 }}
    animate={{ opacity: 1, scale: 1 }}
    transition={{ duration: 2.2 }} className="flex-grow pl-4">
    ...
    initial={{ opacity: 0, scale: 0.5 }}
    animate={{ opacity: 1, scale: 1 }}
    transition={{ duration: 2.7}} className="flex-grow pl-4">
    ...
    initial={{ opacity: 0, scale: 0.5 }}
    animate={{ opacity: 1, scale: 1 }}
    transition={{ duration: 3 }} className="flex-grow pl-4">
        ...
        <img data-testid="img" className="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12" src={sample} alt="step"/>
      </div>
    </div>
  </section>
</div>
