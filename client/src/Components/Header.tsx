...
<header className="text-white body-font w-full h-30 rounded drop-shadow-lg bg-black">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
     <Link to="/about" className="text-white font-bold py-2 px-4 rounded hover:bg-black transition duration-200 ease-in-out" data-testid={'About-Header'}>About</Link>
      <Link to="/pricing" className="text-white font-bold py-2 px-4 rounded hover:bg-black transition duration-200 ease-in-out mr-5"  data-testid={'Price-Header'}>Pricing</Link>
